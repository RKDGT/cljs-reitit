...
var vec__60891 = cljs.core.rest(expr);
...
var G__60897 = x;
var G__60897__$1 = (((G__60897 == null))?null:spec_tools.impl.polish(G__60897));
var G__60897__$2 = (((G__60897__$1 == null))?null:cljs.core.name(G__60897__$1));
if((G__60897__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__60897__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__60898 = x;
var G__60898__$1 = (((G__60898 == null))?null:cljs.core.name(G__60898));
if((G__60898__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__60898__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__60899){
var map__60900 = p__60899;
var map__60900__$1 = cljs.core.__destructure_map(map__60900);
var data = map__60900__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60900__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60900__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60900__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60900__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__60901){
var map__60902 = p__60901;
var map__60902__$1 = cljs.core.__destructure_map(map__60902);
var data = map__60902__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60902__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60902__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__60903 = data;
var G__60903__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60903,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__60903);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60903__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__60903__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__60907 = form;
var G__60907__$1 = (((G__60907 == null))?null:cljs.core.rest(G__60907));
if((G__60907__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__60907__$1);
}
})();
var G__60908 = m;
var G__60908__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60908,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__60904_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__60904_SHARP_)));
})):G__60908);
var G__60908__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60908__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__60905_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__60905_SHARP_)));
})):G__60908__$1);
var G__60908__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60908__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__60906_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__60906_SHARP_));
})):G__60908__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__60908__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__60909 = (function (){var G__60910 = form;
var G__60910__$1 = (((G__60910 == null))?null:cljs.core.rest(G__60910));
if((G__60910__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__60910__$1);
}
})();
var map__60909__$1 = cljs.core.__destructure_map(map__60909);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60909__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60909__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60909__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60909__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__60911 = (function (){var and__4221__auto__ = (kw instanceof cljs.core.Symbol);
...
var temp__5752__auto__ = cljs.core.namespace(key);
if(cljs.core.truth_(temp__5752__auto__)){
var nn = temp__5752__auto__;
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__60912 = form;
var G__60912__$1 = (((G__60912 == null))?null:cljs.core.seq(G__60912));
var G__60912__$2 = (((G__60912__$1 == null))?null:cljs.core.first(G__60912__$1));
if((G__60912__$2 == null)){
return null;
} else {
var fexpr__60913 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__60913.cljs$core$IFn$_invoke$arity$1 ? fexpr__60913.cljs$core$IFn$_invoke$arity$1(G__60912__$2) : fexpr__60913.call(null,G__60912__$2));
}
})():null));
});
/**
...
var len__4829__auto___60924 = arguments.length;
var i__4830__auto___60925 = (0);
while(true){
if((i__4830__auto___60925 < len__4829__auto___60924)){
args__4835__auto__.push((arguments[i__4830__auto___60925]));

var G__60926 = (i__4830__auto___60925 + (1));
i__4830__auto___60925 = G__60926;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq60914){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq60914));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__60915){
var vec__60916 = p__60915;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60916,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60916,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__60921){
var map__60922 = p__60921;
var map__60922__$1 = cljs.core.__destructure_map(map__60922);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60922__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60922__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60922__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60922__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__60919_SHARP_){
return cljs.core.map_QMARK_(p1__60919_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__60920_SHARP_){
return cljs.core.contains_QMARK_(p1__60920_SHARP_,x);
});
}),req_keys));
