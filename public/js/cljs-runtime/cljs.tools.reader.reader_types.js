...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44585 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44585(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44597 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44597(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44598 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44598(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44599 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44599(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44605 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44605(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44606 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44606(reader);
}
});
...
var G__44641 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44642 = s.append(c);
c = G__44641;
s = G__44642;
continue;
}
