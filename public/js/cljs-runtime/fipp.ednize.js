...
var fipp$ednize$IEdn$_edn$dyn_62331 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_62331(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4622__auto__ = (function fipp$ednize$edn_$_iter__62324(s__62325){
return (new cljs.core.LazySeq(null,(function (){
var s__62325__$1 = s__62325;
while(true){
var temp__5754__auto__ = cljs.core.seq(s__62325__$1);
if(temp__5754__auto__){
var s__62325__$2 = temp__5754__auto__;
if(cljs.core.chunked_seq_QMARK_(s__62325__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__62325__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__62327 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__62326 = (0);
while(true){
if((i__62326 < size__4621__auto__)){
var k = cljs.core._nth(c__4620__auto__,i__62326);
cljs.core.chunk_append(b__62327,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__62332 = (i__62326 + (1));
i__62326 = G__62332;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62327),fipp$ednize$edn_$_iter__62324(cljs.core.chunk_rest(s__62325__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62327),null);
}
} else {
var k = cljs.core.first(s__62325__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__62324(cljs.core.rest(s__62325__$2)));
}
} else {
return null;
}
...
var x__$1 = this;
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"ExceptionInfo","ExceptionInfo",294935087,null),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"message","message",-406056002),cljs.core.ex_message(x__$1),new cljs.core.Keyword(null,"data","data",-232669377),cljs.core.ex_data(x__$1)], null),(function (){var temp__5754__auto__ = cljs.core.ex_cause(x__$1);
if(cljs.core.truth_(temp__5754__auto__)){
var cause = temp__5754__auto__;
