...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__62224){
var map__62225 = p__62224;
var map__62225__$1 = cljs.core.__destructure_map(map__62225);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62225__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62225__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__62226 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62226,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62226,(1),null);
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__62231 = cljs.core.get_global_hierarchy;
return (fexpr__62231.cljs$core$IFn$_invoke$arity$0 ? fexpr__62231.cljs$core$IFn$_invoke$arity$0() : fexpr__62231.call(null));
})());
...
var map__62232 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__62232__$1 = cljs.core.__destructure_map(map__62232);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62232__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62232__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__62234){
var vec__62235 = p__62234;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62235,(0),null);
var map__62238 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62235,(1),null);
var map__62238__$1 = cljs.core.__destructure_map(map__62238);
var schema = map__62238__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62238__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__62239 = cljs.core.get_global_hierarchy;
return (fexpr__62239.cljs$core$IFn$_invoke$arity$0 ? fexpr__62239.cljs$core$IFn$_invoke$arity$0() : fexpr__62239.call(null));
})());
...
})(),(function (){var iter__4622__auto__ = (function spec_tools$swagger$core$iter__62240(s__62241){
return (new cljs.core.LazySeq(null,(function (){
var s__62241__$1 = s__62241;
while(true){
var temp__5754__auto__ = cljs.core.seq(s__62241__$1);
if(temp__5754__auto__){
var s__62241__$2 = temp__5754__auto__;
if(cljs.core.chunked_seq_QMARK_(s__62241__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__62241__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__62243 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__62242 = (0);
while(true){
if((i__62242 < size__4621__auto__)){
var vec__62244 = cljs.core._nth(c__4620__auto__,i__62242);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62244,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62244,(1),null);
cljs.core.chunk_append(b__62243,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62243),spec_tools$swagger$core$iter__62240(cljs.core.chunk_rest(s__62241__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62243),null);
}
} else {
var vec__62247 = cljs.core.first(s__62241__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62247,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62247,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__62240(cljs.core.rest(s__62241__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__62250){
var vec__62251 = p__62250;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62251,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62251,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__62254,p){
var vec__62255 = p__62254;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62255,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62255,(1),null);
var acc__$1 = vec__62255;
