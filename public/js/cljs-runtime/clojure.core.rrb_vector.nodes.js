...
var G__62360 = (root.arr[(slc - (1))]);
var G__62361 = (shift - (5));
var G__62362 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__62360;
shift = G__62361;
cnt = G__62362;
continue;
...
if((!(r_QMARK_))){
var rngs_62371 = clojure.core.rrb_vector.nodes.node_ranges(parent);
var rng0_62372 = (rngs_62371[(0)]);
var new_rngs_62373 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_62374 = (rngs_62371[(32)]);
cljs.core.array_copy(rngs_62371,(1),new_rngs_62373,(0),(lim_62374 - (1)));

var i_62375 = (0);
while(true){
if((i_62375 < lim_62374)){
(new_rngs_62373[i_62375] = ((new_rngs_62373[i_62375]) - rng0_62372));

var G__62376 = (i_62375 + (1));
i_62375 = G__62376;
continue;
} else {
}
...
(new_rngs_62373[(32)] = ((rngs_62371[(32)]) - (1)));

(new_rngs_62373[((rngs_62371[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_62373);
} else {
}
...
while(true){
if((i_62377 <= li)){
(new_rngs[i_62377] = ((new_rngs[(i_62377 - (1))]) + step));

var G__62378 = (i_62377 + (1));
i_62377 = G__62378;
continue;
} else {
}
...
while(true){
if((i_62379 <= li)){
(new_rngs[i_62379] = ((rngs[i_62379]) - d));

var G__62380 = (i_62379 + (1));
i_62379 = G__62380;
continue;
} else {
}
...
while(true){
if((j_62381 <= i)){
(rngs[j_62381] = r_62382);

var G__62383 = (j_62381 + (1));
var G__62384 = (r_62382 + step);
j_62381 = G__62383;
r_62382 = G__62384;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__62353 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__62353[(0)] = node.arr.length);
...
var arr_62385__$1 = arr;
var shift_62386__$1 = shift;
while(true){
if((shift_62386__$1 === (5))){
if((!(reg_QMARK_))){
(arr_62385__$1[(32)] = rngs);
} else {
}

(arr_62385__$1[(0)] = node);
} else {
var a_62387 = (new Array(len));
var e_62388 = cljs.core.__GT_VectorNode(null,a_62387);
(arr_62385__$1[(0)] = e_62388);
...
var G__62389 = a_62387;
var G__62390 = (shift_62386__$1 - (5));
arr_62385__$1 = G__62389;
shift_62386__$1 = G__62390;
continue;
}
break;
}
...
var cret = (((shift === (5)))?cljs.core.__GT_VectorNode(null,tail):(function (){var G__62354 = (arr[(li - (1))]);
var G__62355 = (shift - (5));
var G__62356 = ((clojure.core.rrb_vector.nodes.regular_QMARK_(node))?cljs.core.mod(cnt,((1) << shift)):(function (){var li__$1 = ((rngs[(32)]) - (1));
if((li__$1 > (0))){
...
var G__62357 = tail;
return (clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4 ? clojure.core.rrb_vector.nodes.fold_tail.cljs$core$IFn$_invoke$arity$4(G__62354,G__62355,G__62356,G__62357) : clojure.core.rrb_vector.nodes.fold_tail.call(null,G__62354,G__62355,G__62356,G__62357));
})());
