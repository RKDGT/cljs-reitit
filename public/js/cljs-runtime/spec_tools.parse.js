...
var fexpr__60927 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__60927.cljs$core$IFn$_invoke$arity$1 ? fexpr__60927.cljs$core$IFn$_invoke$arity$1(type) : fexpr__60927.call(null,type));
});
...
var G__60930 = spec_tools.impl.normalize_symbol(x);
var G__60931 = null;
var G__60932 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__60930,G__60931,G__60932) : spec_tools.parse.parse_form.call(null,G__60930,G__60931,G__60932));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__60933 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__60934 = x;
var G__60935 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__60933,G__60934,G__60935) : spec_tools.parse.parse_form.call(null,G__60933,G__60934,G__60935));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__60970 = cljs.spec.alpha.form(x);
var G__60971 = options;
x = G__60970;
options = G__60971;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__60936 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__60937 = null;
var G__60938 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__60936,G__60937,G__60938) : spec_tools.parse.parse_form.call(null,G__60936,G__60937,G__60938));
} else {
...
var G__60939 = parse_data;
var G__60939__$1 = (((G__60939 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__60939));
var G__60939__$2 = (((G__60939__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__60939__$1));
var G__60939__$3 = (((G__60939__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__60939__$2));
var G__60939__$4 = (((G__60939__$3 == null))?null:cljs.core.seq(G__60939__$3));
if((G__60939__$4 == null)){
return null;
} else {
return cljs.core.set(G__60939__$4);
}
}
});
...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__60940 = cljs.core.get_global_hierarchy;
return (fexpr__60940.cljs$core$IFn$_invoke$arity$0 ? fexpr__60940.cljs$core$IFn$_invoke$arity$0() : fexpr__60940.call(null));
})());
...
var map__60941 = spec_tools.impl.parse_keys(form);
var map__60941__$1 = cljs.core.__destructure_map(map__60941);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60941__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60941__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60941__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60941__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60941__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__60942 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__60942__$1 = (cljs.core.truth_((function (){var or__4223__auto__ = req;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60942,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__60942);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60942__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__60942__$1;
}
}));
...
var vec__60943 = multi_spec_form;
var seq__60944 = cljs.core.seq(vec__60943);
var first__60945 = cljs.core.first(seq__60944);
var seq__60944__$1 = cljs.core.next(seq__60944);
var _ = first__60945;
var first__60945__$1 = cljs.core.first(seq__60944__$1);
var seq__60944__$2 = cljs.core.next(seq__60944__$1);
var multi_method_symbol = first__60945__$1;
var ___$1 = seq__60944__$2;
var form = vec__60943;
var temp__5754__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (v){
...
var spec = temp__5754__auto__;
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60946){
var vec__60947 = p__60946;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60947,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60947,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__60950_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__60950_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60951_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__60951_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__60952_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__60952_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60953_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__60953_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__60954 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__60954__$1 = cljs.core.__destructure_map(map__60954);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60954__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__60955 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__60955__$1 = cljs.core.__destructure_map(map__60955);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60955__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__60956,options){
var vec__60957 = p__60956;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60957,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60957,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60957,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__60961,options){
var vec__60962 = p__60961;
var seq__60963 = cljs.core.seq(vec__60962);
var first__60964 = cljs.core.first(seq__60963);
var seq__60963__$1 = cljs.core.next(seq__60963);
var ___$1 = first__60964;
var values = seq__60963__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__60960_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__60960_SHARP_,options);
}),values);
...
var type_priority = (function (p1__60965_SHARP_){
var G__60968 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__60967 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__60965_SHARP_);
return (fexpr__60967.cljs$core$IFn$_invoke$arity$1 ? fexpr__60967.cljs$core$IFn$_invoke$arity$1(G__60968) : fexpr__60967.call(null,G__60968));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60966_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__60966_SHARP_,options);
}),cljs.core.rest(form))));
}));
