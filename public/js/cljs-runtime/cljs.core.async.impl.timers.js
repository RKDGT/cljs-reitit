...
var i_47478 = (0);
while(true){
if((i_47478 < arr.length)){
(arr[i_47478] = null);

var G__47479 = (i_47478 + (1));
i_47478 = G__47479;
continue;
} else {
}
...
var i_47508 = (self__.level + (1));
while(true){
if((i_47508 <= (new_level + (1)))){
(update[i_47508] = self__.header);

var G__47509 = (i_47508 + (1));
i_47508 = G__47509;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_47510 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_47510[i]));
} else {
x__$2.forward.push((((i < links_47510.length))?(links_47510[i]):null));
}

if((i < links_47510.length)){
(links_47510[i] = x__$2);
} else {
links_47510.push(x__$2);
}
...
var i_47512 = (0);
while(true){
if((i_47512 <= self__.level)){
var links_47513 = (update[i_47512]).forward;
if((x__$1 === (((i_47512 < links_47513.length))?(links_47513[i_47512]):null))){
(links_47513[i_47512] = (x__$1.forward[i_47512]));

var G__47514 = (i_47512 + (1));
i_47512 = G__47514;
continue;
} else {
var G__47515 = (i_47512 + (1));
i_47512 = G__47515;
continue;
}
} else {
...
var G__47517 = nx;
var G__47518 = (level__$1 - (1));
x = G__47517;
level__$1 = G__47518;
continue;
} else {
var G__47519 = x;
var G__47520 = (level__$1 - (1));
x = G__47519;
level__$1 = G__47520;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__47556 = nx;
var G__47557 = (level__$1 - (1));
x = G__47556;
level__$1 = G__47557;
continue;
} else {
var G__47558 = x;
var G__47559 = (level__$1 - (1));
x = G__47558;
level__$1 = G__47559;
continue;
}
