...
if((x instanceof cljs.core.Keyword)){
var G__60978 = spec;
var G__60979 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__60978,G__60979) : f.call(null,G__60978,G__60979));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__60980 = spec;
var G__60981 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__60980,G__60981) : f.call(null,G__60980,G__60981));
} else {
return x;
...
if(typeof x === 'number'){
var G__60982 = spec;
var G__60983 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__60982,G__60983) : f.call(null,G__60982,G__60983));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e60985){if((e60985 instanceof Error)){
var ___$1 = e60985;
return x;
} else {
throw e60985;
...
}catch (e60987){if((e60987 instanceof Error)){
var ___$1 = e60987;
return x;
} else {
throw e60987;
...
}catch (e60988){if((e60988 instanceof Error)){
var ___$1 = e60988;
return x;
} else {
throw e60988;
...
}catch (e60989){if((e60989 instanceof Error)){
var ___$1 = e60989;
return x;
} else {
throw e60989;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__60990,x){
var map__60991 = p__60990;
var map__60991__$1 = cljs.core.__destructure_map(map__60991);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60991__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__60992,x){
var map__60993 = p__60992;
var map__60993__$1 = cljs.core.__destructure_map(map__60993);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60993__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__60994,x){
var map__60995 = p__60994;
var map__60995__$1 = cljs.core.__destructure_map(map__60995);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60995__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
