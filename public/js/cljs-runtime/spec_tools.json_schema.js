...
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__62178 = cljs.core.get_global_hierarchy;
return (fexpr__62178.cljs$core$IFn$_invoke$arity$0 ? fexpr__62178.cljs$core$IFn$_invoke$arity$0() : fexpr__62178.call(null));
})());
...
var temp__5752__auto__ = (function (){var and__4221__auto__ = infer_titles_QMARK_(options);
...
var map__62212 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__62212__$1 = cljs.core.__destructure_map(map__62212);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62212__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62212__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62212__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62212__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__62213 = spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$1(form);
var map__62213__$1 = cljs.core.__destructure_map(map__62213);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62213__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__62214 = type;
var G__62214__$1 = (((G__62214 instanceof cljs.core.Keyword))?G__62214.fqn:null);
switch (G__62214__$1) {
case "map":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62214__$1)].join('')));
...
var vec__62215 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62215,(3),null);
...
var vec__62218 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62218,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62218,(1),null);
...
var extra_info = (function (){var G__62221 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62221,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__62221;
}
})();
