...
var G__57320 = o;
goog.object.set(G__57320,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__57345__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__57345 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57346__i = 0, G__57346__a = new Array(arguments.length -  0);
while (G__57346__i < G__57346__a.length) {G__57346__a[G__57346__i] = arguments[G__57346__i + 0]; ++G__57346__i;}
  args = new cljs.core.IndexedSeq(G__57346__a,0,null);
} 
return G__57345__delegate.call(this,args);};
G__57345.cljs$lang$maxFixedArity = 0;
G__57345.cljs$lang$applyTo = (function (arglist__57347){
var args = cljs.core.seq(arglist__57347);
return G__57345__delegate(args);
});
G__57345.cljs$core$IFn$_invoke$arity$variadic = G__57345__delegate;
return G__57345;
})()
;
} else {
...
var G__57323 = o;
goog.object.set(G__57323,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__57354__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__57354 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57355__i = 0, G__57355__a = new Array(arguments.length -  0);
while (G__57355__i < G__57355__a.length) {G__57355__a[G__57355__i] = arguments[G__57355__i + 0]; ++G__57355__i;}
  args = new cljs.core.IndexedSeq(G__57355__a,0,null);
} 
return G__57354__delegate.call(this,args);};
G__57354.cljs$lang$maxFixedArity = 0;
G__57354.cljs$lang$applyTo = (function (arglist__57356){
var args = cljs.core.seq(arglist__57356);
return G__57354__delegate(args);
});
G__57354.cljs$core$IFn$_invoke$arity$variadic = G__57354__delegate;
return G__57354;
})()
;
} else {
...
var G__57324 = props;
var G__57324__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57324,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__57324);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57324__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__57324__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__57325 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57325,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__57325;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__57326){
var map__57327 = p__57326;
var map__57327__$1 = cljs.core.__destructure_map(map__57327);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57327__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__57328_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__57328_SHARP_);
}));
} else {
return null;
}
...
var vec__57330 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57330,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57330,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57330,(2),null);
...
var temp__5756__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__5756__auto__ == null)){
return reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null));
} else {
var k = temp__5756__auto__;
return k;
}
});
...
var temp__5758__auto___57384 = reagent.impl.template.key_from_vec(v);
if((temp__5758__auto___57384 == null)){
} else {
var key_57385 = temp__5758__auto___57384;
(jsprops.key = key_57385);
}
...
var temp__5758__auto___57386 = reagent.impl.template.key_from_vec(argv);
if((temp__5758__auto___57386 == null)){
} else {
var key_57387 = temp__5758__auto___57386;
(jsprops.key = key_57387);
}
...
var G__57334 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__57334) : reagent.impl.template.as_element.call(null,G__57334));
} else {
var temp__5758__auto___57388 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5758__auto___57388 == null)){
} else {
var key_57389 = temp__5758__auto___57388;
(jsprops.key = key_57389);
}
...
var G__57336 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__57336)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57336)){
return x;
} else {
...
var len__4829__auto___57390 = arguments.length;
var i__4830__auto___57391 = (0);
while(true){
if((i__4830__auto___57391 < len__4829__auto___57390)){
args__4835__auto__.push((arguments[i__4830__auto___57391]));

var G__57392 = (i__4830__auto___57391 + (1));
i__4830__auto___57391 = G__57392;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq57337){
var G__57338 = cljs.core.first(seq57337);
var seq57337__$1 = cljs.core.next(seq57337);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57338,seq57337__$1);
}));
...
break;
default:
var G__57394 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__57394;
continue;
...
var ctx = ({});
var vec__57341 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57341,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57341,(1),null);
...
var G__57344 = (cljs.core.count(argv) - first_child);
switch (G__57344) {
case (0):
